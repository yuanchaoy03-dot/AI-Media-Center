...
<style scoped>
.auth-page { min-height: 100dvh; display: flex; flex-direction: column; padding: 40px clamp(24px, 4vw, 64px) 24px; }
.auth-brand { display: flex; align-items: center; gap: 10px; font-size: 11px; font-weight: 650; letter-spacing: 1.8px; }
...
.auth-content { width: 100%; max-width: 400px; margin: auto; padding: 56px 0; }
...
input { width: 100%; min-height: 48px; border: 1px solid var(--color-hairline); border-radius: var(--radius-nav); background: var(--color-surface); color: var(--color-text-primary); padding: 12px 14px; font: 14px/1.5 var(--font-ui); transition: border-color var(--motion-fast) var(--motion-ease), background var(--motion-fast) var(--motion-ease); }
...
.auth-switch { margin: 24px 0 0; text-align: center; color: var(--color-text-secondary); font-size: 13px; }
...
.auth-note { display: flex; justify-content: center; align-items: flex-start; gap: 10px; margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--color-hairline); color: var(--color-text-secondary); }
...
.auth-footer { text-align: center; color: var(--color-text-secondary); font-size: 11px; letter-spacing: 2px; }
...
@media (hover: hover) and (pointer: fine) {
  input:hover { border-color: rgb(245 245 247 / 20%); }
