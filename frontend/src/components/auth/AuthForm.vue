...
.auth-collage { position: absolute; inset: -3%; display: grid; grid-template-columns: 1fr 1.3fr 1.05fr 1.1fr; grid-template-rows: 1fr .45fr 1fr; gap: 16px; filter: brightness(.44) saturate(.78) blur(3px); transform: scale(1.03); }
...
.auth-content { position: relative; flex-shrink: 0; width: min(420px, calc(100vw - 40px)); margin: auto; padding: 36px 34px; border: 1px solid rgb(255 255 255 / 10%); border-radius: var(--radius-lg); background: rgb(20 20 22 / 94%); box-shadow: 0 28px 70px rgb(0 0 0 / 36%), inset 0 1px 0 rgb(255 255 255 / 7%); animation: auth-enter 260ms var(--motion-ease); }
.auth-content::before { content: ''; position: absolute; inset: 0; border-radius: inherit; background: linear-gradient(145deg, rgb(255 255 255 / 3.5%), transparent 36%); pointer-events: none; }
...
@supports ((backdrop-filter: blur(1px)) or (-webkit-backdrop-filter: blur(1px))) {
  .auth-content { background: rgb(20 20 22 / 80%); -webkit-backdrop-filter: blur(24px) saturate(118%); backdrop-filter: blur(24px) saturate(118%); }
}
