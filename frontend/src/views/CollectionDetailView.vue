  ...
  <div class="collection-page">
    ...
    <template v-else>
      <section class="collection-hero" aria-labelledby="collection-title">
        <img v-if="collection.backdropUrl && !backdropFailed" class="collection-backdrop" :src="collection.backdropUrl" alt="" @error="backdropFailed = true" />
...
.collection-hero{position:relative;min-height:440px;isolation:isolate;overflow:hidden}
.collection-backdrop{position:absolute;inset:0;z-index:-2;width:100%;height:100%;object-fit:cover;object-position:center 38%}
.collection-hero::after{content:"";position:absolute;inset:0;z-index:-1;background:linear-gradient(0deg,var(--bg),rgba(10,10,11,.22) 90%),linear-gradient(90deg,rgba(10,10,11,.7),transparent)}
