...
Project transparency exceptions are defined in [DESIGN.md](../../../../DESIGN.md), section 11; use its motion durations rather than the generic example below. Full keyboard/focus enhancement follows the project stage.
